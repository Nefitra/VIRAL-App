...
export const roadmapSections: RoadmapSection[] = [
  {
    ...
    items: [
      ...
      { id: "tg_bot_user", label: "Final Telegram bot username", status: "pending", notes: "@viral_promo_bot" },
      { id: "tma_url", label: "Final Telegram Mini App URL", status: "pending", notes: "https://t.me/viral_promo_bot/app" },
      { id: "tg_channel", label: "Official Telegram channel/group links", status: "pending", notes: "t.me/viral_channel" },
